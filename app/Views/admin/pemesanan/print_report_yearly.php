...
<head>
    ...
    <title>Print Laporan Pemesanan Tahunan - Elang Lembah Provider</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="report-title">Laporan Pemesanan Tahunan</div>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <?php if (empty($yearly_data)): ?>
                    <tr>
                        <td colspan="4" class="text-center">Tidak ada data pemesanan yang ditemukan</td>
                    </tr>
                <?php else: ?>
                    <?php $no = 1; ?>
